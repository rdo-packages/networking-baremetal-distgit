...
%{?dlrn: %global tarsources python-networking-baremetal}
%{!?dlrn: %global tarsources python_networking_baremetal}
...
%changelog
* Mon Mar 17 2025 RDO <dev@lists.rdoproject.org> 6.5.0-1
- Update to 6.5.0
